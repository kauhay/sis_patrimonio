...
<div class="modal fade" id="exampleModal" tabindex="+100" role="dialog" aria-labelledby="exampleModalLabel">
<div class="modal-dialog" role="document">
  <div class="modal-content">
	<div class="modal-header">
	  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  <center><h1 class="modal-title" id="exampleModalLabel">Cadastrar novo Item</h1></center>
	</div>
<div class="modal-body">
	  ...
	  <div class="form-group ">
		  <label for="recipient-descrição" class="control-label">Descrição:</label>
		  <input type="text" name="descricao" class="form-control" required>
		</div> 
 
		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Filial:</label>
		...
		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Filial Atual:</label>
		  <select name="filial_atual" class="form-control" required>
		...
		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Localização:</label>
		...
		<div class="form-group col-md-4 col-sm-2 ">
		  <label for="recipient-descrição" class="control-label">Nota:</label>
		  <input type="text" name="nota" class="form-control" required>
		</div>

		<div class="form-group col-md-4 col-sm-2 ">
		  <label for="recipient-descrição" class="control-label">Valor:</label>
		  <input type="text" name="valor" class="form-control" required>
		</div>
		
		<div class="form-group col-md-4 col-sm-2 ">
		  <label for="recipient-descrição" class="control-label">Serie:</label>
		  <input type="text" name="serie" class="form-control" required>
		</div>

		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Emissão:</label>
		  <input type="date" name="emissao" value="" class="form-control">
		</div>


		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Fornecedor:</label>
		...
		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Tipo:</label>
		...
		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Vida Utiu:</label>
		  <input type="text" name="vida_util" value="" class="form-control">
		</div>

		<div class="form-group col-md-4 col-sm-2">
		  <label for="recipient-descrição" class="control-label">Ativo:</label>
		...
		<div class="form-group col-md-4 col-sm-2">
		  ...
		  <input type="text" name="data_cadastro" value="<?php echo"$data2"; ?>" class="form-control">
		</div>
